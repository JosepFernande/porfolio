...
export default function ContactMe() {
    return (
        <section aria-labelledby="contacto-title" className="flex-grow flex flex-col items-center justify-center ">
                ...
                <div className="flex flex-col gap-8 animate-fade-in-up">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <a aria-label="GitHub" className="group flex items-center gap-3 px-5 py-3 rounded-xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-700 hover:border-primary dark:hover:border-primary transition-all duration-300 shadow-sm hover:shadow-md hover:shadow-primary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background-light dark:focus-visible:ring-offset-background-dark" href="https://github.com/JosepFernande" target="_blank" rel="noopener noreferrer">
                                <GitHubDark size={22} />
                                <span className="font-bold text-sm">GitHub</span>
                            </a>
                            <a aria-label="LinkedIn" className="group flex items-center gap-3 px-5 py-3 rounded-xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-700 hover:border-primary dark:hover:border-primary transition-all duration-300 shadow-sm hover:shadow-md hover:shadow-primary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background-light dark:focus-visible:ring-offset-background-dark" href="https://www.linkedin.com/in/josep-fern%C3%A1ndez-a84174247/" target="_blank" rel="noopener noreferrer">
                                <LinkedIn size={22} />
                                <span className="font-bold text-sm">LinkedIn</span>
                            </a>
                            <a aria-label="Email" className="group flex items-center gap-3 px-5 py-3 rounded-xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-700 hover:border-primary dark:hover:border-primary transition-all duration-300 shadow-sm hover:shadow-md hover:shadow-primary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background-light dark:focus-visible:ring-offset-background-dark" href="mailto:fernandezjos98@gmail.com">
                ...
                <div className="w-full">
                    <div className="bg-white dark:bg-surface-dark rounded-2xl p-6 md:p-8 shadow-xl border border-slate-100 dark:border-slate-700 relative overflow-hidden group">
                        ...
                        <form className="flex flex-col gap-6 relative z-10" id="contact-form" >
                            ...
                            <div className="pt-2">
                                <button className="group relative w-full h-14 bg-primary hover:bg-primary-hover text-white rounded-xl font-bold text-base tracking-wide transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden shadow-[0_0_20px_rgba(16,185,129,0.25)] hover:shadow-[0_0_30px_rgba(16,185,129,0.4)] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background-light dark:focus-visible:ring-offset-background-dark" id="submit-btn" type="submit">
