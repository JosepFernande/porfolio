      ...
      <div className="layout-container max-w-240 mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-4 items-center mb-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              aria-label="GitHub"
              className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-gray-200 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-700/60 transition-all duration-300 border border-transparent hover:border-primary/50 hover:shadow-[0_0_15px_rgba(16,185,129,0.3)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background-light dark:focus-visible:ring-offset-background-dark"
            ...
            >
              ...
              <span className="absolute -top-8 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                GitHub
              </span>
            </a>
            <a
